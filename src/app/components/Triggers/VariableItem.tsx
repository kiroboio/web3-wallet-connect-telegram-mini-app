...
export const VariableItem = ({
  ...
  return (
    <div
      key={variable.handle}
      className="border border-gray-200 rounded p-2 transition-colors bg-white duration-200 hover:bg-gray-200 shadow-inner"
      onMouseEnter={() => {
      ...
      onMouseLeave={() => setSelectedTokenAddress?.(undefined)}
    >
